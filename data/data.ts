...
const data: DataType = {
  ...
  sectionAboutMe: {
    ...
    id: "about",
    title: "About Me",
    desc: `<p>My name is Alan and I am currently an senior studying computer science at Cornell University, graduating in May 2023. I have previously interned at Cutler Group as a quantitative trading intern, and also at FINRA as a software engineering intern. I am seeking roles in: </p>`,
    ...
    tabs: [
      {
        ...
        content: {
          ...
          date: "Fall 2023",
          contentList: ["I will be joining IMC in Chicago this fall as a full time quantitative trader."],
        },
      },
      {
        ...
        content: {
          ...
          date: "Spring 2023",
          contentList: ["I will be an incoming software engineer intern at Datadog in New York City this spring."],
        },
      },
      {
        ...
        content: {
          ...
          date: "Summer 2022",
          contentList: ["Cutler Group is an equity options market maker. During the internship, I learned about options theory, mock traded with interns, and also did two projects.", "For my first proejct, I analyzed extremely hard to borrow stocks to see if Merrill Lynch’s loan rate is predictive of the terminal stock price through time with pandas, NumPy, statsmodels, and MySQL.", "For my second project, I helped increase profitabillity by analyzing trades and developing insights into edge retention and trade quality."],
        },
      },
      {
